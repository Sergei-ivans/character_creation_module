...
def attack(char_name: str, char_class: str) -> str:
    """Функция описывает какой урон нанес противнику выбраный тип воина."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция описывает какой урон блокирует выбраный тип воина."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция описывает какое умение применяет выбраный тип воина."""
    if char_class == 'warrior':
